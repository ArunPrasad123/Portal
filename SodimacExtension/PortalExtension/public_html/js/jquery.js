...
();
    ...
    m.event = {
        ...
        trigger : function (b, c, d, e) {
            ...
            void 0, b.target || (b.target = d), c = null == c ? [b] : m.makeArray(c, [b]), k = m.event.special[p] || 
            {
            },
        ...
        dispatch : function (a) {
            ...
            if (i[0] = a, a.delegateTarget = this, !k.preDispatch || k.preDispatch.call(this, a) !== !1) {
                ...
                while ((f = h[b++]) && !a.isPropagationStopped()) {
                    ...
                    {
                    }).handle || e.handler).apply(f.elem, i), 
...
(), m.swap = function (a, b, c, d) {
            ...
            var $b, _b, ac = /^(?:toggle|show|hide)$/, bc = new RegExp("^(?:([+-])=|)(" + S + ")([a-z%]*)$", "i"), cc = /queueHooks$/, dc = [ic], ec = {
                "*" : [function (a, b) {var c = this.createTween(a, b), d = c.cur(), e = bc.exec(b), f = e && e[3] || (m.cssNumber[a] ? "" : "px"), g = (m.cssNumber[a] || "px" !== f &&  + d) && bc.exec(m.css(c.elem, a)), h = 1, i = 20;if (g && g[3] !== f) {f = f || g[3], e = e || [], g =  + d || 1;do h = h || ".5", g /=h,m.style(c.elem,a,g+f);while(h!==(h=c.cur()/ d) && 1 !== h && --i)
                    }
            ...
            m.fn.extend( {
                ...
                stop : function (a, b, c) {
                    ...
                    void 0), b && a !== !1 && this.queue(a || "fx", []), this.each(function () {
                        ...
                        for (e = f.length;e--;)
                        f[e].elem !== this || null != a && f[e].queue !== a || (f[e].anim.stop(c), b = !1, f.splice(e, 1));(b || !c) && m.dequeue(this, a)
                    })
                },
                finish : function (a) {
 ...
 : function () {
            ...
            m.extend( {
                ...
                ajaxPrefilter : Lc(Hc), ajaxTransport : Lc(Ic), ajax : function (a, b) {
                    ...
                    function x(a, b, c, d) {
                        var j, r, s, u, w, x = b;2 !== t && (t = 2, g && clearTimeout(g), i = 
 ...
 : Zc;
            ...
            m.ajaxSetup( {
                ...
                if (!a || "string" != typeof a)
                    return null;"boolean" == typeof b && (c = b, b = !1), b = b || y;
                var d = u.exec(a), e = !c && [];
